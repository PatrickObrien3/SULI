...
x,y,z=np.loadtxt('0o5mgml_NCBD.txt', skiprows=1, usecols=(0,1,2), delimiter=",", unpack=True)
plt.errorbar(x,y,yerr=z,label='0.54 mg/ml')


x,y,z=np.loadtxt('50mM_NaCl_37C.txt', skiprows=1, usecols=(0,1,2), delimiter=",", unpack=True)
plt.errorbar(x,y,yerr=z,label='3.88 mg/ml')

x,y,z=np.loadtxt('6mgml_NCBD.txt', skiprows=1, usecols=(0,1,2), delimiter=",", unpack=True)
plt.errorbar(x,y,yerr=z,label='6.84 mg/ml')
