...
#directories=['/home/jms/ACTR/ACTR_1/', '/home/jms/ACTR/ACTR_2/]
#directories=['/home/jms/1KBH/ANAL/1KBH1/', '/home/jms/1KBH/ANAL/1KBH1/']
...
def renumber_for_EOM(working_directory,count_start):
    ...
    for k in range(1,11):
        ...
        for i in range(k,50001,10):
            print j
            os.system('cp    '+str(i)+'.pdb  '+savedir+str(k)+'/p_actr/'+str(j)+'x.pdb')
            os.system('cp    '+str(i)+'x00.int  '+savedir+str(k)+'/p_actr/'+str(j)+'x00.int')
            os.system('cp    '+str(i)+'x00.log  '+savedir+str(k)+'/p_actr/'+str(j)+'x00.log')
            j+=1
