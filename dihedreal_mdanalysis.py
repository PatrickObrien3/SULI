...
os.system('pwd')
universe= Universe(filename+"_ww.prmtop",filename+"_1us.dcd")
...
if have_matplotlib:
    ...
    savefig("filename of backbone_dihedrals_ramachandran.pdf")
    savefig(" filename of backbone_dihedrals_ramachandran.png")
